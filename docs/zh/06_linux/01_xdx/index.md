...
![根据需要决定是否需要更改软件的安装位置 1](./assets/7.png)
...
![~~VMware 输入许可证密钥 1~~](./assets/13.png)
...
![检查虚拟机软件是否安装了虚拟网卡 2](./assets/17.png)

![检查虚拟机软件是否安装了虚拟网 3](./assets/18.png)
...
![DHCP 设置 1](./assets/23.png)

![DHCP 设置 2](./assets/24.png)
...
![修改文件夹的名称 1](./assets/43.png)

![修改文件夹的名称 2](./assets/44.png)

![修改文件夹的名称 3](./assets/45.png)
...
![配置网络和主机名 1](./assets/57.png)

![配置网络和主机名 2](./assets/58.png)

![配置网络和主机名 3](./assets/59.png)

![配置网络和主机名 4](./assets/60.png)

![配置网络和主机名 5](./assets/61.png)

![配置网络和主机名 6](./assets/62.png)
...
![通过 ifconfig 命令来查看 Linux 的 IP 地址](./assets/66.png)
...
![鼠标点击进去之后，通过键盘上的 Enter 来确认](./assets/73.png)
...
![设置静态 IP 地址 4](./assets/81.png)

![设置静态 IP 地址 5](./assets/82.png)
...
![引导式存储布局配置 1](./assets/86.png)

![引导式存储布局配置 2](./assets/87.png)
