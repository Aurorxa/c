...
![根据需要决定是否需要更改软件的安装位置1](./assets/7.png)

![根据需要决定是否需要更改软件的安装位置2](./assets/8.png)

* ⑤ 更改成功后，单击确定，下一步继续安装：

![更改成功后，单击确定，下一步继续安装](./assets/9.png)
...
![快捷方式设置，单击下一步继续安装](./assets/11.png)
...
![检查虚拟机软件是否安装了虚拟网卡1](./assets/16.png)

![检查虚拟机软件是否安装了虚拟网卡2](./assets/17.png)

![检查虚拟机软件是否安装了虚拟网3](./assets/18.png)
...
![DHCP 设置1](./assets/23.png)

![DHCP 设置2](./assets/24.png)
...
![选择磁盘容量](./assets/38.png)

* ⑭ 指定磁盘文件：下一步即可。

![指定磁盘文件](./assets/39.png)

* ⑮ 创建虚拟机完毕：

![创建虚拟机完毕](./assets/40.png)
...
![修改文件夹的名称1](./assets/43.png)

![修改文件夹的名称2](./assets/44.png)

![修改文件夹的名3](./assets/45.png)
...
![设置操作系统的语言环境为中文](./assets/53.png)

* ④ 设置系统`安装目的地`：

![设置系统安装目的地](./assets/54.gif)

* ⑤ 设置`软件选择`：默认即可

![设置软件选择](./assets/55.gif)
...
![设置 root 的密码](./assets/56.gif)

* ⑦ 配置`网络和主机名`：

![配置网络和主机名1](./assets/57.png)

![配置网络和主机名2](./assets/58.png)

![配置网络和主机名3](./assets/59.png)

![配置网络和主机名4](./assets/60.png)

![配置网络和主机名5](./assets/61.png)

![配置网络和主机名6](./assets/62.png)

* ⑧ 查看`配置网络和主机名`是否成功：

![查看配置网络和主机名是否成功](./assets/63.png)

* ⑨ 点击`开始安装`：漫长的等待……

![点击开始安装](./assets/64.gif)

* ⑩ 安装完成之后，会提示`重启系统`，那就重启吧：

![安装完成之后，会提示重启系统，那就重启](./assets/65.gif)
...
![通过ifconfig命令来查看 Linux 的 IP 地址](./assets/66.png)
...
![鼠标点击进去之后，通过键盘上的Enter来确认](./assets/73.png)

* ③ 设置操作系统的`语言`环境为`English`：

![设置操作系统的语言环境为English](./assets/75.png)
...
![设置静态 IP 地址1](./assets/78.png)

![设置静态 IP 地址2](./assets/79.png)

![设置静态 IP 地址3](./assets/80.png)
...
![设置静态 IP 地址4](./assets/81.png)

![设置静态 IP 地址5](./assets/82.png)
...
![配置 Ubuntu 系统镜像源地址](./assets/85.png)

* ⑨ 引导式存储布局配置，保持默认，下一步即可：

![引导式存储布局配置1](./assets/86.png)

![引导式存储布局配置2](./assets/87.png)

* ⑩ 配置用户名、密码等：

![配置用户名、密码等](./assets/88.png)

* ⑪ 安装 SSH 服务：

![安装 SSH 服务](./assets/89.png)
...
![通过 Xshell 远程连接 Ubuntu](./assets/97.png)
